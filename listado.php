...
<h3 align="center"><em><strong>Búsqueda por apellidos</strong></em></h3>
<h2 align="left">
<ol class="breadcrumb"  style="background-color:#9d1b30; color:#FFFFFF ">
  <li>
    <h3><a href="menu.html" style="color:#FFFFFF">Regresar al menú</a></h3>
  </li>
 </ol>
...
$strsql = "SELECT trabajadores.id_usuario, trabajadores.nombre, trabajadores.apellidos, trabajadores.cel, trabajadores.extencion, trabajadores.puesto,trabajadores.dependencia  FROM trabajadores WHERE trabajadores.apellidos LIKE '%$apellidos%' order by apellidos" ;
